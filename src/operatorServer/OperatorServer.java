...
public class OperatorServer implements Runnable
{
    ...
    public OperatorServer(OperatorType operatorType) throws IOException,
	...
	public void run()
	{
		System.out.println("Servidor de " + operator.getOperatorName()
                + " no ar");
	...
	private void loadProperties() throws FileNotFoundException, IOException 
	{
        ...
        this.serverPort = Integer.parseInt(properties
                .getProperty(this.operatorType + ".port"));
    }
}
